...
export const ZELLIM_PAGE = 'https://zellim.com';
...
export const LIVE_FERDI_API = 'https://desktop.zellim.com'; // TODO: Zellim - Server API HERE
...
export const SEARCH_ENGINE_BING = 'bing';
...
export const SEARCH_ENGINE_URLS = {
  ...
  [SEARCH_ENGINE_BING]: ({ searchTerm }) => `https://bing.com/?q=${searchTerm}`,
};
...
export const SIDEBAR_WIDTH = {
  35: 'Very slim sidebar',
  45: 'Slim sidebar',
  55: 'Normal sidebar',
  68: 'Wide sidebar',
  80: 'Very wide sidebar',
  90: 'Extremely wide sidebar',
};
...
export const LOCAL_SERVER = 'You are using Zellim without a server';
export const SERVER_NOT_LOADED = 'Zellim::SERVER_NOT_LOADED';

export const ALLOWED_PROTOCOLS = ['https:', 'http:', 'ftp:', 'zellim:'];
